      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner "style="height:500px; width: 100%; ">
          <div class="carousel-item active ">
            <img src="./images/bghome.jpg" class="d-block w-100 img-fluid" style="height:500px; width: 100%; " alt="..." >
          </div>

          <div class="carousel-item">
            <img src="./images//c7002b97a6b4925548f2663c64278ff1--blue-houses-colorful-houses.jpg" style=" height:500px; width: 100%; " class="d-block w-100  img-fluid" alt="...">
          </div>

          <div class="carousel-item">
            <img src="./images/asd.jpg" class="d-block w-100 img-fluid "style="height:500px; width: 100%;" alt="...">
          </div>
        </div>
