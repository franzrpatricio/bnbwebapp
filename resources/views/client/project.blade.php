  ...
  <div class="row">
    ...
    <div class="col-lg-6 col-sm-12 col-md-12" data-aos="fade-right" data-aos-duration="3000">
      <div class="row">
        ...
        <a class="row justify-content-md-center mt-3" href="{{url('project/'.$project->id.'/'.$project->slug.'/gallery')}}">
          <button type="button" class="btn btn-outline-primary btn-sm"  data-aos="fade-right" data-aos-duration="1000">View Gallery</button>
        </a>
      </div>
    </div>
    ...
    <div>
      <div class="header" data-aos="fade-right" data-aos-duration="1000" style="background-image: url('{{asset('assets/client/building2.jpg')}}')">
        <div class="p-5 text-center bg-image"  style="filter: brightness(60%);"></div>
