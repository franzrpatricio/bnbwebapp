    ...
    <div class="container1">
      <div class="form animate__animated animate__fadeInLeft animate__delay-0.7s">
          ...
          <div class="contact-info-form"> <span class="circle one"></span> <span class="circle two"></span>
              <form action="#" onclick=" false;" autocomplete="off">
                  ...
                  <div class="social-input-containers textarea"> <textarea name="message" class="input" placeholder="Message"></textarea> </div> <input type="submit" value="Send" class="btn1" />
              </form>
          </div>
      </div>
    </div>
