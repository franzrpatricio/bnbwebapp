               ...
               <div class="col-md-4">
                   <div class="box">
                       <div class="our-services settings">
                           ...
                           <h4>Vision</h4>
                           <p style="text-align:justify;">It's our mission at Bana & Bana Architects to provide client focused service through our responsible practice of Architecture.
               ...
               <div class="col-md-4">
                   <div class="box">
                       <div class="our-services privacy">
                           ...
                           <h4>Mission</h4>
                           <p style="text-align:justify;">To be viewed as a respected architectural firm, providing high quality design and service to our clients with honesty and integrity.
           ...
           <div class="row">
             ...
             <article class="col-md-4 col-lg-3">
               <div class="card-content">
                 <a href="http://uj.ac.za"><img class="spectrum1" src="./images/residencial.jpg" style="height: 200px;" alt="meow">
                 <h4 class="spectrum-h2 text-center text-justify">Residencial</h4>
             ...
             <article class="col-md-4 col-lg-3">
               <div class="card-content">
                 <a href="http://uj.ac.za"><img class="spectrum1" src="./images/roofing.jpg" style="height: 200px;" alt="meow">
                 <h4 class="spectrum-h2 text-center text-justify">Roofing</h4>
                   <p>Bana & Bana Architectural provides excellent roofing services for clients who have difficulty on finding firms who can either fix or build roofs.</p></a>
               </div>
               <!-- .card-content -->
               </a>
             </article>
             ...
             <article class="col-md-4 col-lg-3">
               <div class="card-content">
                 <a href="http://uj.ac.za"><img class="spectrum1" src="./images/asd.jpg" style="height: 200px;" alt="meow">
                 <h4 class="spectrum-h2 text-center text-justify">Condo Interior</h4>
                   <p> Bana & Bana Architecture provides architectural residencial designs and can be built according to the client's own preference of design.</p></a>
               </div>
               <!-- .card-content -->
               </a>
             </article>
             ...
             <article class="col-md-4 col-lg-3">
               <div class="card-content">
                 <a href="http://uj.ac.za"><img class="spectrum1" src="./images/images.jpg" style="height: 200px;" alt="meow">
                 <h4 class="spectrum-h2 text-center text-justify">Design & Build</h4>
                   <p>Bana & Bana Architecture provides floor plans and elevations for easy access to faster designing and building. Design and Build is one of the specialties of the firm.</p></a>
               </div>
               <!-- .card-content -->
               </a>
             </article>
