...
class HousePlanController extends Controller
{
    public function index(){
        ...
        return view('users.staff.houseplan.index', compact('houseplan'));
    }

    public function create(){
        #VIEW category create form
        return view('users.staff.houseplan.create');
    }
    ...
    public function store(HousePlanFormRequest $request){
        ...
        return redirect('staff/houseplan')->with('msg','Successfully Added New House Plan. Thanks!');
    }
    
    #VIEW specific category
    public function edit($houseplan_id){
        $houseplan = HousePlan::find($houseplan_id);
        return view('staff.admin.houseplan.edit', compact('houseplan'));
    }
    ...
    public function update(HousePlanFormRequest $request, $houseplan_id){
        ...
        $houseplan->update();
        #redirect with message;see in index.blade.php
        return redirect('staff/houseplan')->with('msg','Successfully Updated House Plan. Thanks! :D');
    }
    ...
    public function destroy($houseplan_id){
        ...
        if ($houseplan) {
            ...
            $houseplan->delete();
            return redirect('staff/houseplan')->with('msg','Successfully Deleted House Plan');
        }else {
            return redirect('staff/houseplan')->with('msg','No House Plan ID found');
        }
    }
}
