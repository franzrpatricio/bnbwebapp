...
class CategoryController extends Controller
{
    public function index(){
        ...
        return view('users.staff.category.index', compact('category'));
    }

    public function create(){
        #VIEW category create form
        return view('users.staff.category.create');
    }
    ...
    public function store(CategoryFormRequest $request){
        ...
        return redirect('staff/category')->with('msg','Successfully Added New Category. Thanks!');
    }
    
    #VIEW specific category
    public function edit($category_id){
        $category = Category::find($category_id);
        return view('users.staff.category.edit', compact('category'));
    }
    ...
    public function update(CategoryFormRequest $request, $category_id){
        ...
        $category->update();
        #redirect with message;see in index.blade.php
        return redirect('staff/category')->with('msg','Successfully Updated Category. Thanks! :D');
    }
    ...
    public function destroy($category_id){
        ...
        if ($category) {
            ...
            $category->delete();
            return redirect('staff/category')->with('msg','Successfully Deleted Category');
        }else {
            return redirect('staff/category')->with('msg','No Category ID found');
        }
    }
}
