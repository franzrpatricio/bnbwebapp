...
class ProjectsController extends Controller
{
    ...
    public function index(){
        ...
        return view('users.staff.project.index', compact('projects'));
    }
    #CREATE
    public function create(){
        ...
        return view('users.staff.project.create', compact('category','houseplan'));
    ...
    public function store(ProjectFormRequest $request){
        ...
        $project->save();
        return redirect('staff/projects')->with('msg','Successfully Created Project');
    }
    ...
    public function edit($project_id){
        ...
        return view('users.staff.project.edit', compact('project', 'category','houseplan'));
    }
    ...
    public function update(ProjectFormRequest $request, $project_id){
        ...
        $project->posted_by = Auth::user()->id;
        $project->update();
        return redirect('staff/projects')->with('msg','Successfully Updated Project');
    }
    #DELETE
    public function destroy($project_id){
        ...
        if ($project) {
            ...
            $project->delete();
            return redirect('staff/projects')->with('msg','Successfully Deleted Project');
        }else {
            return redirect('staff/projects')->with('msg','No Project ID found');
        }
    }
}
